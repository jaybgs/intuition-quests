...
export function EditProfile({ onBack }: { onBack: () => void }) {
  ...
  const handleConnectTwitter = async () => {
    ...
    if (result.success) {
      setSaveMessage('Twitter connected successfully!');
  ...
  const handleConnectDiscord = async () => {
    ...
    if (result.success) {
      setSaveMessage('Discord connected successfully!');
      setTimeout(() => setSaveMessage(null), 3000);
    } else {
  ...
  const handleConnectEmail = async () => {
    ...
    if (result.success) {
      setSaveMessage('Email connected successfully!');
      setTimeout(() => setSaveMessage(null), 3000);
    } else {
      setSaveMessage(`Failed to connect Email: ${result.error}`);
      setTimeout(() => setSaveMessage(null), 5000);
    }
  };
  ...
  const handleConnectGithub = async () => {
    ...
    if (result.success) {
      setSaveMessage('GitHub connected successfully!');
      setTimeout(() => setSaveMessage(null), 3000);
    } else {
  ...
  const handleDisconnectSocial = (platform: 'twitter' | 'discord' | 'email' | 'github') => {
    ...
    setSaveMessage(`${platform.charAt(0).toUpperCase() + platform.slice(1)} disconnected`);
    setTimeout(() => setSaveMessage(null), 3000);
  };
    ...
    <div className="edit-profile">
      ...
      <div className="edit-profile-content">
        ...
        <div className="edit-section">
          ...
          <p className="section-description">Connect your social accounts for verification</p>
          ...
          <div className="social-connections-grid">
            ...
            <div className="social-connection-item">
              <div className="social-connection-header">
                ...
                <div className="social-connection-info">
                  <h3 className="social-connection-name">Google/Email</h3>
                  {connections.email ? (
                    <p className="social-connection-status connected">
              ...
              <div className="social-connection-actions">
                {connections.email ? (
                  <button
                    onClick={() => handleDisconnectSocial('email')}
                    className="social-disconnect-button"
